...
#SBATCH --job-name=vljepa-vanilla-train      # Name shown in squeue
...
#SBATCH --output=logs/train_vanilla_%j.out   # stdout; %j expands to SLURM job ID
#SBATCH --error=logs/train_vanilla_%j.err    # stderr; kept separate for easier debugging
...
python train_vanilla.py "$@" --batch_size 32 --epochs 10
